...
export function buildData() {
  ...
  return {
    ...
    terminals: {
      ...
      unbound: [
        agentState({ sid: 'u1', state: 'working', conf: 'event', since: ago(5 * MIN), model: 'claude-opus-4-8',
          title: 'Migrate the ETL jobs to the new scheduler', pid: 5221, tty: null, cwd: dirOf('data-pipeline'), repo: dirOf('data-pipeline'), host: 'tmux' }),
